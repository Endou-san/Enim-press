...
class ProfileScreenEditor extends StatelessWidget {
  const ProfileScreenEditor({Key? key}) : super(key: key);
    ...
    return StreamBuilder<DatabaseEvent>(
      ...
      builder: (BuildContext context, AsyncSnapshot<DatabaseEvent> snapshot) {
        if (snapshot.connectionState == ConnectionState.active) {
          ...
          String tMenuAjouterArticle = 'Ajouter un Article';
          String tMenuMesArticles = 'Mes articles';
                  ...
                  children: [
                    ...
                    ListTile(
                      leading: Container(
                        ...
                        child: Icon(LineAwesomeIcons.plus, color: Colors.green),
                      ),
                      title: Text(tMenuAjouterArticle,
                    ...
                    ListTile(
                      leading: Container(
                        ...
                        child: Icon(LineAwesomeIcons.edit, color: Colors.blue),
                      ),
                      title: Text(tMenuMesArticles,
                          style: Theme.of(context).textTheme.bodyText1),
                      trailing: Container(
                        width: 30,
                        height: 30,
                    ...
                    ListTile(
                      leading: Container(
                        ...
                        child:
                            Icon(LineAwesomeIcons.alternate_sign_out, color: Colors.yellow),
                      ),
                      title: Text(tMenuDeconnecter,
                          style: Theme.of(context).textTheme.bodyText1),
                     trailing: Container(
                        width: 30,
                        height: 30,
